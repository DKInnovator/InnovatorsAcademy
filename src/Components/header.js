...
const Header = () => {
  ...
  <Link to="#" className="navbar-brand"  ><img src="./logo.png"  alt='Logo ' width={"110px"} height={"120px"}/></Link>
    ...
    <div className="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
      ...
      <div className="social-part">
          <Link  to="/Aboutus" > <i className="fa-brands fa-facebook fa-lg" style={{paddingRight:"50px"}}></i> </Link>
          <Link to="/Aboutus" >  <i className="fa-brands fa-square-instagram fa-lg" style={{color: "#c81e81",paddingRight:"50px" }}></i> </Link>
          <Link to="/Aboutus">  <i className="fa-brands fa-youtube fa-lg" style={{color: "#d92020",paddingRight:"50px" }}></i> </Link>
